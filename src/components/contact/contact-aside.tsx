    ...
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-card bg-ink-950 p-7 text-white sm:p-8">
        ...
        <div className="relative">
          <p className="text-eyebrow text-accent-500">Prefer WhatsApp?</p>
          ...
          <a
            ...
            className="group mt-6 inline-flex items-center gap-3 rounded-full bg-accent-500 px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-accent-600"
          >
            Chat on WhatsApp
